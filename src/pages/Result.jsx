...
const GRADES = [
  ...
  { min: 50, label: 'Хорошо! 👍', color: '#4d96ff', emoji: '👍', msg: 'Неплохой результат! Продолжай учиться и станет ещё лучше!' },
  { min: 0, label: 'Учись! 💪', color: '#ff6b6b', emoji: '💪', msg: 'Не расстраивайся! Каждый тест — это новые знания!' },
];

export default function Result() {
  const navigate = useNavigate();
  const [result] = useLocalStorage('bq_quiz_result', null);
  const [, , clearState] = useLocalStorage('bq_quiz_state', null);
